...
--
-- Table structure for table `auditlog_jobapplicationstatushistory`
--

DROP TABLE IF EXISTS `auditlog_jobapplicationstatushistory`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `auditlog_jobapplicationstatushistory` (
  ...
  `isPartialUpdate` bit(1) DEFAULT NULL,
  ...
  `ActualMins` int(11) DEFAULT NULL,
...
--
-- Dumping data for table `auditlog_jobapplicationstatushistory`
--

LOCK TABLES `auditlog_jobapplicationstatushistory` WRITE;
/*!40000 ALTER TABLE `auditlog_jobapplicationstatushistory` DISABLE KEYS */;
/*!40000 ALTER TABLE `auditlog_jobapplicationstatushistory` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2018-08-16 13:48:24
